...
app.get('/tamil-success', (req, res) => res.sendFile(path.join(__dirname, 'public', 'tamil-success.html')));
app.get('/gk-success', (req, res) => res.sendFile(path.join(__dirname, 'public', 'gk-success.html')));
app.get('/combo-success', (req, res) => res.sendFile(path.join(__dirname, 'public', 'combo-success.html')));
